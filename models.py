...
class QuizForm(Form):
    ...
    usrname = TextField('Ihr Benutzername', validators=[InputRequired(message="Bitte geben Sie einen Benutzernamen an")])
    ...
    symptoms = SelectMultipleField('Wählen Sie aus, unter welchen Symptomen Sie leiden(zum Markieren mehrerer Optionen am PC Strg-Taste (Ctrl) gedrückt halten):', 
        choices=[
